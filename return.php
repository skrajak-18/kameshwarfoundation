...
<head>
    ...
    <title>Kameshwar Foundation | Return Policy</title>
    ...
    <style>
        ...
        .page-header { background: linear-gradient(rgba(17, 26, 47, 0.85), rgba(17, 26, 47, 0.85)), url('img/h3.jpeg') center/cover no-repeat; padding: 80px 0; color: white; text-align: center; }
...
<body>
    ...
    <header class="page-header">
        <div class="container" data-aos="fade-up">
            ...
            <p class="fs-5 mt-3">Information regarding subscription cancellations and merchandise returns.</p>
        </div>
    </header>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-10" data-aos="fade-up">
                    <div class="policy-content">
                        <div class="text-center"><span class="last-updated"><i class="fas fa-sync-alt me-2"></i> Last Updated: May 2026</span></div>

                        <p>This Return and Cancellation Policy outlines the conditions under which you may cancel a recurring donation subscription or return any physical items received from <strong>Kameshwar Foundation</strong>.</p>

                        <h4>1. Cancellation of Monthly / Recurring Donations</h4>
                        <p>If you have set up a recurring (monthly, quarterly, or yearly) donation through our website, you have the right to cancel it at any time. </p>
                        <ul>
                            <li><strong>How to Cancel:</strong> You can cancel your recurring donation by sending an email to <strong>info@kameshwarfoundation.in</strong> with your Name, Registered Email ID, and Subscription ID.</li>
                            <li><strong>Notice Period:</strong> Please allow us up to 3 business days to process the cancellation. If a scheduled donation goes through during this processing time, it will be considered a valid donation and will not be refunded.</li>
                        </ul>

                        <h4>2. Return of Physical Merchandise (Charity Shop)</h4>
                        <p>In the event that Kameshwar Foundation offers physical merchandise (such as T-Shirts, Mugs, or Books) where the proceeds go towards our charity drives, the following return rules apply:</p>
                        <ul>
                            <li><strong>Eligibility:</strong> Returns are only accepted if the item received is defective, damaged during shipping, or if the wrong item was delivered.</li>
                            <li><strong>Timeframe:</strong> You must request a return within <strong>7 days</strong> of receiving the item.</li>
                            <li><strong>Condition:</strong> The item must be unused, unwashed, and in the same condition that you received it. It must also be in the original packaging.</li>
                        </ul>

                        <h4>3. Process for Returning Merchandise</h4>
                        <p>If you meet the eligibility criteria for returning a physical item:</p>
                        <ol>
                            <li>Contact us at <strong>info@kameshwarfoundation.in</strong> with photos of the defective/incorrect item.</li>
                            <li>Once approved, we will provide you with a return shipping address (Darbhanga, Bihar).</li>
                            <li>After we receive and inspect the returned item, we will either send a replacement or process a refund for the item's purchase value (excluding shipping costs).</li>
                        </ol>

                        <h4>4. Contact Us</h4>
                        <p>If you have any questions or require assistance regarding our return or cancellation policy, please contact us immediately. We are here to help.</p>
